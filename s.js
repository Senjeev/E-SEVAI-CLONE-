   ...
   function allLetter1()
	...
	function income(){
		...
		if(inc==""){
							  document.getElementById("message9").innerHTML="<span style='font-size: 18;color:red; font-family:monospace;'>*Please Enter the income*";
							  return false;
		}
		else 
			{
	...
	function check()
{
	...
	if((num.charAt(0)!=9)&&(num.charAt(0)!=8)&& (num.charAt(0)!=7)){
	  ...
	  function allLetter6()
      { 
	  var name2=document.getElementById("tex3").value
      var letters = /^[A-Za-z.. ]+$/;
      if(name2.match(letters))
      {
      return true;
